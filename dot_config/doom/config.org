...
** Define Stuck Projects (Need To Uncomment)
...
** After Org Settings (Commented Out)
...
** Org-Modern-Indent (Commented Out)
...
** Prettifying Agenda Based On [[https:www.youtube.com/watch?v=a_WNtuefREM][This YouTube Video]] (Commented Out)
